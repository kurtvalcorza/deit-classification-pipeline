"""Static release-asset validation for the DeiT-Small image-classification DIMER pipeline.
...
EXPECTED_MODEL_ID = "facebook/deit-small-patch16-224"
...
EXPECTED_OUTPUTS = (
    "deit_classification_input_manifest.json",
    "deit_classification_evaluation_report.json",
    "deit_classification_result.json",
    "deit_classification_predictions.csv",
    "deit_adapter.safetensors",
)
